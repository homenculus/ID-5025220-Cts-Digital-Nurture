...
public class EmployeeManagementSystemApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        System.out.println("Employee and Department initialized.");
        System.out.println("Department: " + departmentRepository.findAll().get(0).getName());
        System.out.println("Employee: " + employeeRepository.findAll().get(0).getName());
    }
}
